...
$register_site->setRequestLogoutRedirectUri(Oxd_RP_config::$post_logout_redirect_uri);
...
$update_site_registration->setRequestLogoutRedirectUri(Oxd_RP_config::$post_logout_redirect_ur);
...
$logout->setRequestPostLogoutRedirectUri(Oxd_RP_config::$post_logout_redirect_ur);
